...
Insert into TB_PLAYER (PLAYER_ID,NAME,SEX,BIRTH_DATE) values (72,'GRACE','F',to_timestamp('17/12/99 00:00:00,000000000','DD/MM/RR HH24:MI:SS,FF'));
Insert into TB_PLAYER (PLAYER_ID,NAME,SEX,BIRTH_DATE) values (13,'MARY','F',to_timestamp('02/06/89 00:00:00,000000000','DD/MM/RR HH24:MI:SS,FF'));
Insert into TB_PLAYER (PLAYER_ID,NAME,SEX,BIRTH_DATE) values (24,'JOHN','M',to_timestamp('29/01/94 00:00:00,000000000','DD/MM/RR HH24:MI:SS,FF'));
Insert into TB_PLAYER (PLAYER_ID,NAME,SEX,BIRTH_DATE) values (58,'MAX','M',to_timestamp('13/07/98 00:00:00,000000000','DD/MM/RR HH24:MI:SS,FF'));
